...
export async function generateMetadata({ params }: { params: { slug: string } }): Promise<Metadata> {
  ...
  return {
    ...
    description: match.description_short || `Previa exclusiva de ${match.home_team} vs ${match.away_team}. Transmisión HD por STADIOTV.`,
...
export default async function MatchPage({ params }: { params: { slug: string } }) {
  ...
  // Obtenemos los bloques HTML infinitos (custom_blocks)
  ...
  return (
    <main className="min-h-screen bg-[#050505] text-white font-sans selection:bg-red-600 pb-20">
      ...
      {/* HERO SECTION PRO: Banner fundido suave */}

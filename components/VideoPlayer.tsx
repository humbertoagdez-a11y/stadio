...
export default function VideoPlayer({ highlights }: { highlights: any[] }) {
  ...
  return (
    <div className="space-y-8">
      {activeUrl && (
        <div className="aspect-video w-full bg-black rounded-[32px] md:rounded-[40px] overflow-hidden border border-white/10 shadow-2xl relative z-10 shadow-[0_0_60px_rgba(168,85,247,0.1)]">
          <iframe
            src={`${activeUrl}?autoplay=1`}
